...
public class WrYoleWidgetProvider extends AppWidgetProvider {
    ...
    public static void updateLauncherWidgets() {
        ...
        final ComponentName comp = new ComponentName(context, WrYoleWidgetProvider.class);
        ...
        context.sendBroadcast(new Intent(context, WrYoleWidgetProvider.class)
