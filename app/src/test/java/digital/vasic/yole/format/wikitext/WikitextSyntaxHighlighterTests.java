...
public class WikitextSyntaxHighlighterTests {
    ...
    public static class PatternOverallTests {
        ...
        public void webLinkInSentence() {
            ...
            Matcher matcher = pattern.matcher("Visit [[https://github.com/vasic-digital/Yole|Yole on Github]] now!");
            assertThat(matcher.find()).isTrue();
            assertThat(matcher.group()).isEqualTo("[[https://github.com/vasic-digital/Yole|Yole on Github]]");
        }
