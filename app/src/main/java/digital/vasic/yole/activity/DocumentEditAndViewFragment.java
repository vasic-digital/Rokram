...
import digital.vasic.yole.frontend.DraggableScrollbarScrollView;
import digital.vasic.yole.frontend.FileInfoDialog;
...
import digital.vasic.yole.frontend.textview.LineNumbersTextView;
...
import digital.vasic.yole.web.YoleWebViewClient;
import digital.vasic.yole.widget.TodoWidgetProvider;
...
public class DocumentEditAndViewFragment extends YoleBaseFragment implements FormatRegistry.TextFormatApplier {
    ...
    private YoleWebViewClient _webViewClient;
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        _cu = new YoleContextUtils(activity);
        ...
        _webViewClient = new YoleWebViewClient(_webView, activity);
    ...
    public boolean onOptionsItemSelected(@NonNull final MenuItem item) {
        ...
        switch (itemId) {
            ...
            case R.id.action_load_epub: {
                YoleFileBrowserFactory.showFileDialog(new GsFileBrowserOptions.SelectionListenerAdapter() {
                                                            @Override
            ...
            case R.id.action_set_font_size: {
                ...
                YoleDialogFactory.showFontSizeDialog(activity, current, (newSize) -> {
                    if (_isPreviewVisible) {
