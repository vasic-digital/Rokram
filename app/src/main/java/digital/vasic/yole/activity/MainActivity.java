...
import digital.vasic.yole.frontend.NewFileDialog;
...
import digital.vasic.opoc.frontend.filebrowser.GsFileBrowserFragment;
...
import other.writeily.widget.WrYoleWidgetProvider;

public class MainActivity extends YoleBaseActivity implements GsFileBrowserFragment.FilesystemFragmentOptionsListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        _startFolder = YoleContextUtils.getValidIntentFile(getIntent(), fallback);
    ...
    public void onActivityFirstTimeVisible() {
        ...
        if (startTab != R.id.nav_notebook && YoleContextUtils.getValidIntentFile(getIntent(), null) == null) {
    ...
    protected void onNewIntent(final Intent intent) {
        ...
        final File file = YoleContextUtils.getValidIntentFile(intent, null);
    ...
    public GsFileBrowserOptions.Options getFilesystemFragmentOptions(GsFileBrowserOptions.Options existingOptions) {
        if (_filesystemDialogOptions == null) {
            _filesystemDialogOptions = YoleFileBrowserFactory.prepareFsViewerOpts(this, false, new GsFileBrowserOptions.SelectionListenerAdapter() {
