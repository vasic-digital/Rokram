...
import digital.vasic.yole.util.BackupUtils;
...
public class SettingsActivity extends YoleBaseActivity {
    ...
    public static class SettingsFragmentMaster extends YoleSettingsFragment {
        ...
        protected void onPreferenceChanged(final SharedPreferences prefs, final String key) {
            ...
            if (eq(key, R.string.pref_key__language)) {
                ...
                new YoleContextUtils(getActivity()).applySpecialLaunchersVisibility(getActivity(), extraLaunchersEnabled);
        ...
        public Boolean onPreferenceClicked(Preference preference, String key, int keyResId) {
            ...
            switch (keyResId) {
                ...
                case R.string.pref_key__quicknote_filepath: {
                    ...
                    }, fragManager, getActivity(), YoleFileBrowserFactory.IsMimeText);
                    return true;
                }
                ...
                case R.string.pref_key__set_encryption_password: {
                    YoleDialogFactory.showSetPasswordDialog(getActivity());
                    break;
                }
