package digital.vasic.yole.frontend.filesearch;
...
import digital.vasic.yole.frontend.filesearch.FileSearchEngine.FitFile;
...
public class FileSearchResultSelectorDialog {
    ...
    public static void showDialog(
        ...
        final GsSearchOrCustomTextDialog.DialogOptions opts = YoleDialogFactory.baseConf(activity);
