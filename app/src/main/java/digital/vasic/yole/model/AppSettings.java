...
import digital.vasic.yole.util.ShortcutUtils;
...
public class AppSettings extends GsSharedPreferencesPropertyBackend {
    ...
    private final YoleContextUtils _cu;

    public static AppSettings get(final Context context) {
        if (context instanceof YoleBaseActivity) {
            return ((YoleBaseActivity) context).getAppSettings();
