...
public class MarkdownActionButtons extends ActionButtonBase {
    ...
    public boolean onActionClick(final @StringRes int action) {
        switch (action) {
            ...
            case R.string.abid_markdown_table_insert_columns: {
                YoleDialogFactory.showInsertTableRowDialog(getActivity(), false, this::insertTableRow);
                return true;
            }
    ...
    public boolean onActionLongClick(final @StringRes int action) {
        switch (action) {
            case R.string.abid_markdown_table_insert_columns: {
                YoleDialogFactory.showInsertTableRowDialog(getActivity(), true, this::insertTableRow);
                return true;
            }
            case R.string.abid_markdown_code_inline: {
    ...
    public boolean runTitleClick() {
        ...
        YoleDialogFactory.showHeadlineDialog(getActivity(), _hlEditor, _webView, _headlineDialogState, (text, start, end) -> {
